    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-brand-primary p-20 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-brand-secondary rounded-full flex items-center justify-center text-white font-black text-xs">H</div>
            <div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-24 bg-white overflow-y-auto">
        <div className="max-w-md w-full mx-auto py-8">
          ...
          <div className="mb-10">
            <div className="w-12 h-12 bg-brand-primary rounded-xl flex items-center justify-center text-white font-black italic mb-6 shadow-lg shadow-brand-primary/20 text-xl">D</div>
